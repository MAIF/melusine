...
from melusine.prepare_email.cleaning import (
    remove_multiple_spaces_and_strip_text, remove_accents,
    flag_items, remove_transfer_answer_header)
...
@pytest.mark.parametrize("input_str, expected_str", [
    ("Bonjour, mon email : prenom.nom@hotmail.fr", "Bonjour, mon email :  flag_mail_ "),
