...
def discrimination():
    ...
    df_emails_preprocessed['clean_text'] = df_emails_preprocessed['clean_header'] + " " + df_emails_preprocessed[
        'clean_body']
    ...
    st.write("X is a Pandas dataframe with a clean_text column that will be used for the text input and columns \
