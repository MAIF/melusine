...
from melusine.regex.dissatisfaction_regex import DissatisfactionRegex
...
__all__ = ["EmergencyRegex", "ReplyRegex", "ThanksRegex", "TransferRegex", "VacationReplyRegex", "DissatisfactionRegex"]
